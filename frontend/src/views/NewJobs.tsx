...
export default function NewJobs() {
  ...
  if (loading && jobs.length === 0) return <p className="text-gray-500">Loading new jobs...</p>
      ...
      <div>
        ...
        {jobs.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-400 text-lg mb-2">No new jobs yet</p>
            <p className="text-gray-400 text-sm">Jobs will appear here after the first HN sync.</p>
          </div>
        ) : (
          <>
